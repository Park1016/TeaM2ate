...
function EditType({form, setForm, data, setData}) {
    ...
    const [totalNum, setTotalNum] = useState(Object.values(data.item)[0].totalNum);
    ...
    return (
        <>
            ...
            <ul className={cx('container')}>
                <li>
                    <p>유형</p>
                    <SelectBox value={t} data={setType} defaultValue={type} disabled={true}/>
                </li>
                <li>
                    <p>모집 인원</p>
                    <SelectBox value={n.slice(1)} data={setTotalNum} defaultValue={totalNum} />
                </li>
                <li>
                    <p>모집된 인원</p>
                    <SelectBox value={n.slice(0, parseInt(totalNum)+1)} data={setNum} defaultValue={num} />
                </li>
