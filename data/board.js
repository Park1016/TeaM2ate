...
export async function getBoard() {
    return board.filter((x) => x.table === 'findTeam');
}

export async function getBoardByAmount(table, start, amount) {
    return board.filter((x) => x.table === table).slice(start, start+amount);
}